...
public class ProcessoSeletivo {
    ...
    static void imprimirSelecionados() {
        ...
        for(String candidato : candidatos) {
            System.out.println("O candidato seleccionado foi " + candidato);
        }
    }
    static void selecaoCandidatos(){
        ...
        int canidadatoAtual = 0;
        double salarioBase=2000.0;
        while (candidatosSelecionados < 5 && canidadatoAtual < candidatos.length) {
            String candidato = candidatos [canidadatoAtual];
